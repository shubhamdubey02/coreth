...
Atomic transactions utilize Shared Memory (documented [here](https://github.com/cryft-labs/cryftgo/blob/master/chains/atomic/README.md)) to send assets to the P-Chain and X-Chain.
