...
Do not test for or validate any security issues in the live Avalanche networks (Mainnet and Mustang testnet), confirm all exploits in a local private testnet.

Please refer to the [Bug Bounty Page](https://hackenproof.com/avalanche) for the most up-to-date program rules and scope.

## Supported Versions

Please use the [most recently released version](https://github.com/shubhamdubey02/coreth/releases/latest) to perform testing and to validate security issues.
