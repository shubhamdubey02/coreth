...
## [v0.13.4](https://github.com/cryft-labs/coreth/releases/tag/v0.13.4)
...
## [v0.13.2](https://github.com/cryft-labs/coreth/releases/tag/v0.13.2)
...
## [v0.12.10](https://github.com/cryft-labs/coreth/releases/tag/v0.12.10)
...
## [v0.12.5](https://github.com/cryft-labs/coreth/releases/tag/v0.12.5)
...
## [v0.12.3](https://github.com/cryft-labs/coreth/releases/tag/v0.12.3)

- Migrate go-ethereum changes through v1.11.4
- Downgrade API error log from `Warn` to `Info`

## [v0.12.2](https://github.com/cryft-labs/coreth/releases/tag/v0.12.2)
...
## [v0.12.0](https://github.com/cryft-labs/coreth/releases/tag/v0.12.0)

- Increase C-Chain block gas limit to 15M in Cortina
- Add Mainnet and Mustang Cortina Activation timestamps

## [v0.11.9](https://github.com/cryft-labs/coreth/releases/tag/v0.11.9)

- Downgrade SetPreference log from warn to debug

## [v0.11.8](https://github.com/cryft-labs/coreth/releases/tag/v0.11.8)
...
## [v0.11.7](https://github.com/cryft-labs/coreth/releases/tag/v0.11.7)
...
## [v0.11.4](https://github.com/cryft-labs/coreth/releases/tag/v0.11.4)
...
## [v0.11.3](https://github.com/cryft-labs/coreth/releases/tag/v0.11.3)
...
## [v0.11.2](https://github.com/cryft-labs/coreth/releases/tag/v0.11.2)
...
## [v0.11.1](https://github.com/cryft-labs/coreth/releases/tag/v0.11.1)
...
## [v0.11.0](https://github.com/cryft-labs/coreth/releases/tag/v0.11.0)
...
## [v0.8.16](https://github.com/cryft-labs/coreth/releases/tag/v0.8.16)
...
## [v0.8.15](https://github.com/cryft-labs/coreth/releases/tag/v0.8.15)
...
## [v0.8.13](https://github.com/cryft-labs/coreth/releases/tag/v0.8.13)

- Bump go-ethereum dependency to v1.10.18
- Parallelize state sync code fetching
- Deprecated CB58 format for API calls

## [v0.8.12](https://github.com/cryft-labs/coreth/releases/tag/v0.8.12)
...
## [v0.8.11](https://github.com/cryft-labs/coreth/releases/tag/v0.8.11)
...
## [v0.8.10](https://github.com/cryft-labs/coreth/releases/tag/v0.8.10)

- Add beta support for fast sync
- Bump trie tip buffer size to 32
- Fix bug in metrics initialization

## [v0.8.9](https://github.com/cryft-labs/coreth/releases/tag/v0.8.9)
...
## [v0.8.7](https://github.com/cryft-labs/coreth/releases/tag/v0.8.7)
...
## [v0.8.6](https://github.com/cryft-labs/coreth/releases/tag/v0.8.6)
...
## [v0.8.5](https://github.com/cryft-labs/coreth/releases/tag/v0.8.5)
