...
//
//	mockgen -package=precompileconfig -destination=precompile/precompileconfig/mocks.go github.com/shubhamdubey02/corethreth/precompile/precompileconfig Predicater,Config,ChainConfig,Accepter
//
