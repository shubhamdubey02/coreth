...
//
//	mockgen -package=contract -destination=precompile/contract/mocks.go github.com/shubhamdubey02/coreth/precompile/contract BlockContext,AccessibleState,StateDB
//
